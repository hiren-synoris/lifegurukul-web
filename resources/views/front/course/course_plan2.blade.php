                        ...
                        <div class="user_discount_options">
                         ...
                         @if ($coupons->count() > 0)
                            <div class="coupon_remove">
                                ...
                                <span class="coupon_msg" style="font-size: 16px;"> </span> <a href="javascript:void(0)" class="cancel_coupon"  style="display:none;color: #F2751F;text-transform: capitalize;font-size: 16px;text-decoration: underline;"  title="Cancel coupon"> Remove </a>
                            </div>
                        @endif
                         </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".cancel_coupon", function() {
            ...
            $(".updated_coin").text(" Wallet (Available Success Coins: ₹" + available_coin+ ' per coin)')

            $(".coin_manage li:nth-child(3)").html("Used Coins: <span>₹" + used_coins+"</span>")
        ...
        $(".apply_coupon").click(function() {
            ...
            $(".coin_manage li:nth-child(2)").html("Coupon Discount: <span>₹" + parseInt(discount) + '.00</span>').show();
        ...
        $(document).on("click", ".wallet", function() {
            ...
            if (wallet_value == "on") {
                ...
                $(".updated_coin").text(" Wallet (Available Success Coins: " + totalplus + ') (₹' + per_price +
                    ' per coin)')
                updateButton(0, 0, "");
                $(".coin_manage li:nth-child(3)").html("Used Coins: <span>₹" + '0.00</span>').hide();
            }
        ...
        function updateButton(coins, get_total, per_price) {
            ...
            if (checkedValue == 0.00) {
                ...
                if (coins != 0) {
                    ...
                    $(".coin_manage li:nth-child(3)").html("Used Coins: <span>₹" + coins + '.' + '00</span>').show();
                }
                // else {
