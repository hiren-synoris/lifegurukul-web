...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-8">
            ...
            @if(request()->route('packageId'))
            <a href="{{ route("packages.learners",request()->route('packageId'),'learners' ) }}" class="btn btn-success">Back</a>
            @endif
            @if(request()->route('courseId'))
            <a href="{{ route("courses.learners",request()->route('courseId'),'learner' ) }}" class="btn btn-success">Back</a>
            @endif
