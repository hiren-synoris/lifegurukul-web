    ...
    <div id="filter_div" class="row">
        <div class="col-12">
            <div class="row">
                ...
                <div class=""><button class='btn btn-primary text-white export_login_learner'>Export</button></div>
            </div>
        ...
        $(document).ready(function() {
            table_learner = $('#tbl_learners')
                .DataTable({
                    ...
                    responsive: true,
                    ajax: {
                        url: "{{ route('login_learner_report') }}",
                        data: function(d) {
                ...
                if (isFilterDataEmpty(filter_data)) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var url = "{{ URL::to('backoffice/login-learner-export') }}?" + $
                                .param({
