...
@section('content')
    ...
    <div id="filter_div" class="row">
        <div class="col-12">
            <div class="row">
                ...
                <div class=""><button class='btn btn-primary text-white export_purchase'>Export</button></div>
            </div>
                            ...
                            <form action="{{ url('backoffice/send_notifications') }}" method="POST">
                                ...
                                <div class="row d-none my-2">
                                    <div class="col-12 d-flex align-items-center ">
                                        ...
                                        <div class="col-8">
                                            <input type="text" class="form-control float-right" name="signup_date" id="signup_date">
                                        </div>
                                        <div class="col-1">
                                            <span class="" style="color: red !important;cursor: pointer !important;"
                                ...
                                <div class="row d-none my-2">
                                    <div class="col-12 d-flex align-items-center ">
                                        ...
                                        <div class="col-8">
                                            <select class="custom-select w-100" id="payment_status"
                                                name="payment_status">
                                ...
                                <div class="row d-none my-2">
                                    <div class="col-12 d-flex align-items-center ">
                                        ...
                                        <div class="col-8">
                                            <input type="text" id="age" class="form-control" name="age" placeholder="Enter greater than Age" />
                                        </div>
                                        <div class="col-1">
                                            <span class="" style="color: red !important;cursor: pointer !important;"
                                ...
                                <div class="row d-none my-2">
                                    <div class="col-12 d-flex align-items-center ">
                                        ...
                                        <div class="col-4">
                                            <input type="text" placeholder="from" id="price" class="form-control" name="price" />
                                        </div>
                                        <div class="col-4">
                                            <input type="text" placeholder="To" id="priceTo" class="form-control" name="priceTo" />
                                        </div>
                                        <div class="col-1">
                                            <span class="" style="color: red !important;cursor: pointer !important;"
                                ...
                                <div class="row d-none my-2">
                                    <div class="col-12 d-flex align-items-center ">
                                        ...
                                        <div class="col-8">
                                            <select class="custom-select w-100" id="gender"
                                                name="gender">
    ...
    <table id="tbl_purchase" class="table table-bordered table-hove w-100 only_active">
...
@includeIf('admin.layouts.partials.scripts.script-list',[
    ...
    <script>
        ...
        $(document).ready(function() {
             ...
             table_purchase = $('#tbl_purchase').DataTable({
                processing: true,
                serverSide: true,
                searching: false,
                ajax: {
                    url: "{{ route('purchase_course_report') }}",
                    data: function(d) {
        ...
        $(function () {
            $(".export_purchase").click(function () {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "You want to export Purchase Vs Course Complete Report?",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        var ids = $("#tbl_purchase input:checked").map(function(){return $(this).data('id');}).get().join();
                        var url = "{{URL::to('backoffice/purchase-export')}}?" +$.param({"user_seles":user_seles,filter_data,ids})
                        window.location = url;
                    }
                });
