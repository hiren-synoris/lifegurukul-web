<aside class="main-sidebar sidebar-light-info elevation-4">
    ...
    $courseData = \App\Models\Course::withTrashed()->find($courseID);    
    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    @if(request()->routeIs('courses.*'))
                    @php $href = route('courses.learners', ['id' => $courseID]); 
                    @endphp
                    @endif
                    @if(request()->routeIs('packages.*'))
                ...
                <li class="nav-item">
                    ...
                    @php $href = route('courses.public-forum', ['id' => $courseID]); @endphp
                    
                    <a href="{{ $href }}" class="nav-link {{ request()->routeIs('courses.public-forum') ? 'active' : '' }}">
