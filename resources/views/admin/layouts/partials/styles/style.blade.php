...
@if(isset($ratingCSS) && $ratingCSS == 1)
    <!-- Bootstrap switch CSS -->
    <link rel="stylesheet" href="{{ asset('admin/plugins/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/plugins/css/fontawesome.min.css') }}">
@endif
