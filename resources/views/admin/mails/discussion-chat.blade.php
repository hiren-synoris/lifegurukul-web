...
@section('title', 'Discussion created successfully.')
@section('mail-body')
                                          ...
                                          <tr>
                                             <td data-text="Title" data-font="Primary" align="center" valign="middle" style="font-family: 'Poppins',sans-serif;
                                                ...
                                                <div class="list-messges">
                                                   ...
                                                   <p>New discussion comment in <b>{{ isset($course) && !empty($course->title) ? $course->title : '' }}</b> has been added by <b> {{ isset($sender) && !empty($sender->name) ? ucfirst($sender->name) : '' }} </b>
                                                   </p>
