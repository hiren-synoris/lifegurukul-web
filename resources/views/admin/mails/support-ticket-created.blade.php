                                          ...
                                          <tr>
                                             <td data-text="Title" data-font="Primary" align="center" valign="middle" style="font-family: 'Poppins',sans-serif;
                                                ...
                                                <div class="list-messges">
                                                   ...
                                                   <p>New support ticket #<b>{{ isset($support) && !empty($support->id) ? $support->id : '' }}</b> has been created by <b> {{ isset($instructor) && !empty($instructor->name) ? ucfirst($instructor->name) : '' }} </b>
                                                   </p>
